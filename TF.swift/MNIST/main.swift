...
func readFile(_ filename: String) -> [UInt8] {
	let path = "/Users/kyungyoungheo/Projects/swift/TF.swift/TF.swift/MNIST/"

    let d = Python.open(path+filename, "rb").read()
...
func train(_ parameters: inout MNISTParameters, epochCount: Int32) {
	...
	print("\n\nCorrectness : \(Float(correctGuesses) / Float(totalGuesses))")
}
